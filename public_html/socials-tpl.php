<div id="main">
    ...
    <div id="profiles" class="row">
        <div class="profile fourcol">
            ...
            <p>Thursday night kicks off the conference with a PHP London style pubcon. We'll meet at <a href="http://www.cafekick.co.uk/bar-kick/">Bar Kick</a> in Shoreditch from 6pm for FREE drinks and FREE food and some awesome table football action (we'll be in the basement bar). Then at 8pm we'll listen to <a href="https://twitter.com/marcgear">Marc Gear</a>'s talk Node.js vs PHP Smackdown, then a few more drinks, chat and table football matches to finish off the night. <a href="http://www.meetup.com/phplondon/events/105006532/">Let us know</a> if you'll be making it over. The Thursday social is open to anyone. Food and drinks are generously sponsored by <a href="http://github.com">GitHub</a>.</p>
        </div>
        <div class="profile fourcol">
